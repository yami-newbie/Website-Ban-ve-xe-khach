...
namespace BVXK.Application.GetLichTrinh
{
    [Service]
    public class GetLichTrinh
    {
        private ILichTrinhManager _lichTrinhManager;

        public GetLichTrinh(ILichTrinhManager lichTrinhManager)
        {
            _lichTrinhManager = lichTrinhManager;
        }

        public LichTrinhViewModel Do(int id)
            => _lichTrinhManager.GetLichTrinhById(id,
                x => new LichTrinhViewModel
                {
                    IdLichTrinh = id,
                    IdXe = x.IdXe,
